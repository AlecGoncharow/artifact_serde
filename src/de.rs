...
///```
///
pub fn map_card_ids_to_cards(sets: Vec<&str>) -> Result<HashMap<usize, crate::Card>, String> {
...
fn set_up_deck_map(sets: Vec<crate::CardSet>) -> HashMap<usize, crate::Card> {
    let mut map = HashMap::<usize, crate::Card>::new();
    for set in sets {
